...
/***/ function(module, exports, __webpack_require__) {
	...
	var Server = _interopRequire(__webpack_require__(1));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Server = (function () {
	    function Server() {
	        var baseUrl = arguments[0] === undefined ? "" : arguments[0];
	    ...
	    _createClass(Server, {
	        init: {
	            ...
	            value: function init(data) {
	                for (var _name in data) {
	                    this.addCollection(_name, new Collection(data[_name]));
	                }
	            }
	        },
	        initInterceptor: {
	            value: function initInterceptor(data) {
	                for (var _name in data) {
	                    this.addCollectionInterceptor(_name, data[_name]);
	                }
	            }
	        },
	        toggleLogging: {
	        ...
	        addCollectionInterceptor: {
	            value: function addCollectionInterceptor(name, interceptors) {
	                name = name.toLowerCase();
	                if (!this.collectionsInterceptors[name]) {
	                    this.collectionsInterceptors[name] = {};
	                }
	                for (var action in interceptors) {
	        ...
	        respond: {
	            value: function respond(body, headers, request) {
	                var status = arguments[3] === undefined ? 200 : arguments[3];
	        ...
	        getCollectionInterceptor: {
	            value: function getCollectionInterceptor(method, collection) {
	        ...
	        runCollectionInterceptor: {
	            value: function runCollectionInterceptor(method, collection, request,id) {
	                if (this.getCollectionInterceptor(method, collection) == null) {
	                    return null;
	        ...
	        handle: {
	            ...
	            value: function handle(request) {
	                ...
	                try {
	                    for (var _iterator = this.getCollectionNames()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                        var _name = _step.value;

	                        var matches = request.url.match(new RegExp("^" + this.baseUrl + "\\/(" + _name + ")(\\/(\\d+))?(\\?.*)?$"));
	                        if (!matches) continue;
	                        if (!matches[2]) {
	                            if (request.method == "GET") {

	                                var result = this.runCollectionInterceptor("LIST", _name, request,null);
	                                if (result != null) {
	                                ...
	                                var count = this.getCount(_name, countParams);
	                                var items = undefined,
	                                    contentRange = undefined,
	                                    _status = undefined;
	                                if (count > 0) {
	                                    items = this.getAll(_name, params);
	                            ...
	                            if (request.method == "POST") {
	                                var result = this.runCollectionInterceptor(request.method, _name, request,null);
	                                if (result != null) {
	                                    return this.respond(result.data,result.headers,request,result.status);
	                                }

	                                var newResource = this.addOne(_name, request.json);
	                                var newResourceURI = this.baseUrl + "/" + _name + "/" + newResource[this.getCollection(_name).identifierName];
	                            ...
	                            if (request.method == "GET") {
	                                try {
	                                    var result = this.runCollectionInterceptor(request.method, _name, request,id);
	                                    if (result != null) {
	                                        return this.respond(result.data,result.headers,request,result.status);
	                                    }
	                                    var item = this.getOne(_name, id);
	                            ...
	                            if (request.method == "PUT") {
	                                try {
	                                    var result = this.runCollectionInterceptor(request.method, _name, request, id);
	                                    //EDRvar result = this.runCollectionInterceptor(request.method, _name, request);
	                                    if (result != null) {
	                                        return this.respond(result.data,result.headers,request,result.status);
	                                    }
	                                    var item = this.updateOne(_name, id, request.json);
	                                    return this.respond(item, null, request);
	                                } catch (error) {
	                                    return request.respond(404);
	                                }
	                            ...
	                            if (request.method == "DELETE") {
	                                try {
	                                    var result = this.runCollectionInterceptor(request.method, _name, request);
	                                    if (result != null) {
	                                        return this.respond(result.data,result.headers,request,result.status);
	                                    }
	                                    var item = this.removeOne(_name, id);
	                                    return this.respond(item, null, request);
	                                } catch (error) {
	                                    return request.respond(404);
	                                }
	        ...
	        getIndex: {
	            value: function getIndex(identifier) {
	                ...
	                return this.items.findIndex(function (item) {
	                    return item[_this.identifierName] == identifier;
	                });
	            }
	        },
	        getOne: {
	            value: function getOne(identifier) {
